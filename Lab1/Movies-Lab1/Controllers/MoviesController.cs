...
namespace Movies_Lab1.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        // GET: api/Movies
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Movie>>> GetMovies(int? minReleaseYear)
        {
            if (minReleaseYear == null)
            {
                return await _context.Movies.ToListAsync();
            }
            return await _context.Movies.Where(m => m.ReleaseYear >= minReleaseYear).ToListAsync();
        }
